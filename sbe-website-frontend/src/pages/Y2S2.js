...
export default function YtwoStwo() {
  const [courses, setCourses] = useState([]);
  useEffect(() => {
    axios
      .get("http://localhost:8000/api/courseungraduateyeartwo/")
            ...
            <div className="col-lg-8 col-xl-12 card rounded-3 courses-b border border-2 border-light">
              <div className="margin">
                <div className="card-body p-4 p-md-5">
                    <h1 className="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Students Courses Year Two</h1>
                </div>
